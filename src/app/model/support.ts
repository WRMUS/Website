...
export const SUPPORT_SECTION_1 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        + '<br><br>' + '	Practices of Transformative Justice include:'
  ...
  export const SUPPORT_SECTION_2 = [
  {
  ...
  export const SUPPORT_SECTION_3 = [
  {
    ...
    quotes: [
      {
        ...
        + '<br><br>' + '<a href="http://www.generationfive.org/wp-content/uploads/2013/07/G5_Toward_Transformative_Justice-Document.pdf#page=34" target="_blank">-\"Toward Transformative Justice. A Liberatory Approach to Child Sexual Abuse and other forms of Intimate and Community Violence\", p. 28.</a>',
        personId: 11
      },
      {
        ...
        + '<br><br>' + '<a href="http://www.creative-interventions.org/wp-content/uploads/2012/06/CI-Toolkit-Complete-Pre-Release-Version-06.2012-.pdf#page=124" target="_blank">-\"Creative Interventions Toolkit: A Practical Guide to Stop Interpersonal Violence\", p. 3-12.</a>',
        personId: 12
      },
      {
