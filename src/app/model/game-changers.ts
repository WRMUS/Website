...
export const GAME_CHANGERS_SECTION_1 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: 'created the “What really makes us safe?” project. They have found community and purpose in the anti-violence movement for the last fifteen years and were inspired by the visionary work of women and queer folks of color who built the transformative justice movement. Melanie co-founded the Berlin Transformative Justice Collective and published the “What really makes us safe?” <a href="https://www.edition-assemblage.de/buecher/was-macht-uns-wirklich-sicher/" target="_blank">toolkit</a>, as well as a <a href="https://www.unrast-verlag.de/neuerscheinungen/was-tun-bei-sexualisierter-gewalt-detail" target="_blank">guide</a> to working with people who’ve caused sexual harm (both in German). Currently, they are a graduate student in sociology at the University of California, Santa Barbara, exploring participatory action research as a movement building tool.',
        personId: 0,
        photo: 'melanie.jpg'
      },
      {
  ...
  export const GAME_CHANGERS_SECTION_2 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: 'I felt really invested in the work because that partner who I was living with... moved out of our old apartment after <strong>she was attacked by a stranger in the lobby of our building</strong>. Dealing with all the follow up from that, trying to help her through it, and also then her being like "Hey maybe you should acknowledge that this has been traumatic for you too?" And me being like "No, I\'m cool"... and having to look in the face of the fact that it was, in fact, very traumatic for me.'
        + '<br><br>' +'The first night I went out after that, I didn\’t stay home with her, I went out with this old buddy of mine. He was like "Any news?" and I was like "I don\’t know, ... they might have a guy caught." My buddy was like "You know, look, I got an uncle that owes me a favor. Just get me the name, I\'ll take care of it." I was kind of like "Oy yoy yoy. That\’s crazy." That got me sort of thinking about, well, obviously <strong>I don’t feel like I\'m in position to have any human killed, right? No matter how I am angry at them...</strong> My friend, I think he was trying to be compassionate in his own way. He comes from a very different, very violent place and that\’s just how it makes sense. But... that got me thinking about <strong>well, does the State have the place to just lock this guy up... is that helpful either, is that going to fix anything?</strong>'
        + '<br><br>' +'I talked with my partner about [that]. How we were both experiencing compassion for this person in this weird way, without being forgiving of what he did, but couldn\'t make peace with the violence of the state.'
        + '<br><br>' +'<strong>I used to joke that I have an \'empathy disorder\'</strong>. There\'s this guy that used to beat me up in high school. He was high on crack one night, he held a gun to my face and told me that he was gonna kill me. It was the scariest night of my life. We had all these mutual friends, we were part of the same suburban subculture crew, and... I found out that he had been seriously sexually and physically abused by his father as a very young kid. <strong>I was viscerally terrified of him... but I would also be thinking, "This poor guy must be in such deep pain if [this is] the only joy he seems to get out of the world</strong>". Because I had my own issues but I was more or less pretty happy and comfortable and I felt that there was a place for me in the world that I didn\’t need to be constantly reasserting because I wasn\’t forced to do that.'
        + '<br><br>' +'So my partner was also saying "Look, this was horrible but I wonder what the circumstances were for this person to do this thing". She and some friends organized these survivor peer-support meetings, and some of those people ultimately started Support New York and asked me to join.',
        personId: 2
      },
      {
...
export const GAME_CHANGERS_SECTION_3 = [
  {
  ...
  export const GAME_CHANGERS_SECTION_4 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: '<strong>We\’ve been doing perpetrator accountability processes for 7 years. That\’s fucking crazy</strong>, that\’s nuts. At least for the past few years, I almost exclusively have done perpetrator accountability work, which I think is complicated shit. When we started doing perpetrator accountability work, we were asked by someone to do a process for them. And we did a really bad job because we\’d never done that before, and then they called us selfish assholes in a big international magazine, like, last week. So that\’s weird. But again, we failed them 100%. We had no idea. The thing about Support New York is that <strong>none of us are professionals. We\'re not bringing any kind of expertise to the situation, we\'re bringing fumbling human emotion and compassion and whatever</strong>. And that has its benefits, but clearly also has its drawback'
        + '<br><br>' + 'So, I tried to fix my own bathtub, not too long time ago [...] The highest possible cost for me to do my own plumbing and fuck up is measured in dollars, hundreds of dollars maybe, but in dollars nonetheless. With the Support New York work and the kind of amateur, entry-level, fumbling through doing mental health stuff with people, that <strong>cost is much greater if we fail</strong>. A lot of our failures that we realized over the years came from <strong> our inability to see our own limits and set boundaries</strong> for ourselves with people who we were working with. We needed to do <em>everything<\em> because otherwise, why are we even doing anything, you know? And so, I guess, we hurt a lot of people, we let a lot of people down.'
        + '<br><br>' +'I just have to... it\'s not about me. I was just about to say "I just have to live with that, <strong>but it\'s not about me that we let those people down, it\'s about them</strong>. And I don\'t know how to best be accountable to those people since... you tell a million perpetrators during accountability processes, "Hey, <strong>it doesn\'t matter what your intentions were, the outcome is that you harmed somebody</strong> and now you have to accept that and address that." <strong>So how do we accept that and address that?</strong>',
        personId: 2
      },
      {
        tagline: 'Shitstorm',
      ...
      {
        tagline: 'Hypocrite?',
        quote: '[...] I was <strong>engaged in multiple accountability processes</strong>, and then I was <strong>also simultaneously engaging in some of the same behaviors we were critiquing in my relationship</strong>. I basically stayed wasted all the time, like low level drunk all the time, that I just didn\’t have to think about that. Then it kind of came to a head and all this stuff came out to my partner, that I\’d been lying constantly to hide how much I was drinking. I had really eroded our trust.'
        + '<br><br>' +
        'So Support New York had this big meeting, I was crying, I was weeping, "I have to quit the collective, I\'m a monster." And they were like, "Cut it out, don’t be a fucking idiot." I quit. <strong>I kicked myself out of the collective</strong>. But they were like, "What you did was bad, but <strong>why don’t you just have a process?</strong>" '
          + '<br><br>' +'And so me and Milo, we did a process for me. I started going to therapy. I quit drinking. [...]'
          + '<br><br>' +'But until it all came out, I was living this double life, sitting in an [accountability] meeting and describing a manipulative tactic that the perpetuator was habitually engaging in and thinking about how I was doing exactly that at the moment in my relationship, you know? It really speaks to how insidious some of these behaviors are. <strong>Does that disqualify me for being able to do this work?</strong> Is there like a purity thing where <strong>only the pure can heal</strong>, who fucking knows? But I still do it and nobody in collective wants me to stop. My partner isn\'t mad at me anymore, it feels like I was honest and did work on healing myself and her, so that\’s probably pretty good, right?',
        personId: 2
      },
      {
      ...
      },
      {
        ...
        quote: 'I couldn\'t do this work if I wasn\'t able to <strong>empathize with perpetrators</strong> to some extent. That\'s why I can\'t do survivor support right now because, and I haven\'t been able to for a while, because <strong>seeing myself in the survivors</strong> is too... is <strong>not something I can handle right now because of my own past trauma</strong>. And it goes both ways, people can\'t do perpetrator work because they can\'t empathize with the perpetrator, and there is nothing wrong with that.'
        + '<br><br>' + 'I can empathize... and also I tend to be the \'bad cop\' a lot of times - I hate that I just said \'cop,\' [but] you know what I mean.  I would be the one being really mean in the meetings. I\'m not just like, "Oh, I\'m compassionate to you."',
        personId: 2
      },
      {
