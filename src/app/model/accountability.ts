...
export const ACCOUNTABILITY_SECTION_1 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: 'Even if we use some <strong>light coercion</strong> in the processes, we do need people that <strong>consent</strong> to them in the first place. You can\'t be forced into a process. The point is that you can\'t really make someone do what they don\'t want to do.'
        + '<br><br>' + '<strong>One of the biggest inhibitors</strong> to people being receptive to these processes is that <strong>their friends</strong> are like "Come on, man, fuck that. Come on, why is she trying to railroad you like that? Why you gotta do this? You\'re not a bad guy! Why do you have to go to these meetings?" It\'s like the <strong>patriarchy defending itself in these tiny battlegrounds all day long, everywhere, in these insidious ways</strong> among people that think they are better than that. Or they think they have escaped the machinations of our fucked-up culture.',
        personId: 2
      },
      {
  ...
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: 'Maybe there are hierarchies of abuse? Perhaps I haven\'t thought any of this through, I\'ve just been knee-jerky saying that there are no hierarchies of abuse for so long that it\'s time to reexamine that. [...] Even if there are [hierarchies], that doesn\'t mean that all of them don\'t have to be addressed. That is a <strong>dumb tactic to distract us</strong> from the actual issue.  Some abuse is worse than others, but it all still needs to get dealt with, and in my experience doing processes, the <strong>less severe stuff is way easier to address</strong>. The process is going easier, the trauma is not as great oftentimes, and it is easier to deal with. So why not just deal with it, unless you\'re too lazy to deal with it. I think <strong>it doesn\'t matter if there are hierarchies of abuse, because abuse is still abuse</strong> and it needs to be addressed and healed, whatever it is.',
        personId: 2
      },
      {
  ...
  export const ACCOUNTABILITY_SECTION_2 = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        + '<br><br>' + 'Support New York published its <a href="https://supportny.org/transformative-justice/curriculum/" target="_blank">accountability process curriculum</a> for its work with persons who cause harm',
        personId: 18
      },
      {
 ...
        + '<br><br>' +'-The Abolitionist newspaper, 2012, p. 7',
      ...
      },
      {
        ...
        quote: 'Planning accountability for people who abuse'
          ...
          + '<br><br>' + '<strong>Intimate Networks: extended family, family friends and relations, natural allies</strong>'
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        tagline: 'Paradox of teaching consent via coercion',
        quote: 'It\'s tough because you\'re <strong>trying to teach people how to not do coercive behaviors but you use mildly coercive behaviors to teach them how not to do coercive behaviors</strong>. It\'s really a weird thing that we struggle with all the time and always question, but at the end of the day it is kind of like...  There are different forms of coercion and there are different forms of... I don\'t know, I don\'t have the theory, I\'ll let some academic figure it out... But we use social pressure [on] someone that doesn\'t feel bad for doing something terrible, but they should feel terrible for doing something terrible. What\'s the difference between that and making someone feel like they\'re not a free love anarchist revolutionary if they don\'t let me stick my hand into their pants? You know, there\'s a social pressure, it\'s a similar notion. I guess one thing is an <strong>indiviual exerts pressure to advance a selfish goal that directly traumatizes the recipient</strong> and the other is when <strong>a group or a community exerts pressure for a broader community goal.</strong>',
        personId: 2
      },
      {
      ...
      },
      {
        ...
        quote: 'These <a href="assets/pdf/Confidentiality-Transparency.pdf" target="_blank">guidelines</a> around confidentiality and transparency were developed as part of a process with a person who caused harm.',
        personId: 17
      },
      {
  ...
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        quote: '<strong>It\'s a human thing. It\'s not like we are de-programming Blade Runners</strong>, you know what I mean?  We\'re interacting with a human so the <strong>curriculum is a loose framework</strong>. You can\'t just force the curriculum down and say, "Ok we\'ll go through this and that, and you\'re healed! By the rules of the patriarchy, now I heal you," boom, like televangelists, "Your body is cleansed of sexism. Be on your way!"  It is not like that. We read[...] and we have all these conversations, we talk about people\'s chilhoods, we talk about our own chilhoods, we talk about how we got into punk.'
        ...
        + '<br><br>' +'I wish I could demystify it a little bit, it\'s like I put a bunch of change in my hand and then I hold a bandana in front of it and I pull the bandana off and a dove flies out. It is like, "What happened to the bandana?" I don\'t know, but <strong>it happens every single time... and there is no magician</strong>.',
        personId: 2
      },
      {
  ...
  export const ACCOUNTABILITY_SECTION_3 = [
  {
